...
# If the volcano elevation is less then 1000 meters color the volcano green, between 1000 and 3000 meters color the volcano orange, otherwise color the volcano red
